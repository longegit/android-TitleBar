...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            int leftImageId = ta.getResourceId(R.styleable.TitleBar_tb_left_image, 0);
            int titleColor = ta.getColor(R.styleable.TitleBar_tb_title_color, 0xFFFFFFFF);
            int actionTextColor = ta.getColor(R.styleable.TitleBar_tb_action_text_color, 0xFFFFFFFF);
